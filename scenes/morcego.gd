...
# ---------- Estado de itens ----------
var nearby_items: Array[Area2D] = []   # itens dentro da área do morcego
...
# ===================================================================
#  DETECÇÃO DE ITENS
#  O PRÓPRIO Bat (Area2D root) recebe area_entered/area_exited
# ===================================================================

func _on_Bat_area_entered(area: Area2D) -> void:
	# Só queremos itens (grupo "itens", igual o Player usa)
...
func _pickup_item(item_area: Area2D) -> void:
	...
	# Ajusta posição local (pendurado embaixo do morcego)
...
func _move_toward_target(delta: float) -> void:
	# Efeito de "pairar" vertical para o Sprite
